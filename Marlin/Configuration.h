...
#define STRING_CONFIG_H_AUTHOR "JamesK, SKR Pro, TMC2209" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Anycubic Kossel - run 'M106 S255' & 'M303 E0 C10 S210'
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // from pid autotune. "M303 E-1 C8 S60" to run autotune on the bed at 60 degreesC for 8 cycles
    ...
    #define DEFAULT_bedKp 351.17
    #define DEFAULT_bedKi 66.55
    #define DEFAULT_bedKd 1235.42
  #endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 407.10 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN     PD5     // LED driving pin
