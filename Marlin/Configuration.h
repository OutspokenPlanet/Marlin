...
#define STRING_CONFIG_H_AUTHOR "JamesK, Anet AM8, 18/04/20" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AM8 SKR 1.4 TMC2209"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //E3D-Hemera
  //From PID Autotune run 'M106 S255' & 'M303 E0 C10 S210'
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // RatRig AM8 Wham Bam PEX
  // from PID Autotune run 'M303 E-1 C8 S60'
  #define DEFAULT_bedKp 139.78
  #define DEFAULT_bedKi  23.97
  #define DEFAULT_bedKd 543.31
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 400, 805 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 800, 800, 15, 300 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -35, -1.9 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 36       // Number of LEDs in the strip, larger of 2 strips if 2 neopixel strips are used
